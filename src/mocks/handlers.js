...
export const handlers = [
  rest.post("http://localhost:9001/api/login", login),
  rest.post("http://localhost:9001/api/logout", logout),
  rest.get("http://localhost:9001/api/friends", getAll),
  rest.get("http://localhost:9001/api/friends/:id", getById),
  rest.post("http://localhost:9001/api/articles", create),
];
